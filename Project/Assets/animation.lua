...
-- Animation
for i=1,20,1 do
    puppet_node:translate(-0.01, 0, -0.01)
    puppet_node:rotate('y', 18)
    puppet_node:translate(0.01, 0, 0.01)
    joint_1:rotate('z', 18)
    gr.render(scene, string.format("animation-%i.png", i), 500, 500, {-0.5, -1, 5}, {0, 0, -800}, {0, 1, 0}, 50, {0.3, 0.3, 0.3}, {white_light}, 16, 5, 5, 0, 0)
end


-- threads, reflec level, refract level, glossy rays, shadow rays
--gr.render(scene, 'animation.png', 500, 500,
--{-0.5, -1, 6}, {0, 0, -800}, {0, 1, 0}, 50,
--{0.3, 0.3, 0.3}, {white_light}, 8, 5, 5, 0, 0)