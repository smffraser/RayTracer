...
puppet_node:rotate('y', 90)

gr.render(scene, string.format("puppet.png"), 500, 500, {1, 0, 5}, {0, 0, -800}, {0, 1, 0}, 50, {0.3, 0.3, 0.3}, {white_light}, 16, 5, 5, 0, 0)
